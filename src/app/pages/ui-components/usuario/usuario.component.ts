...
export class AppUsuarioComponent implements OnInit {
  ...
  actualizarImagenUsuario() {
    ...
    this.http.put(`https://dioses121.pythonanywhere.com/api/usuarios/actualizar/${this.dni}/`, formData, { headers }).subscribe(
      (response: any) => {
  ...
  actualizarUsuario() {
    ...
    this.http.put(`https://dioses121.pythonanywhere.com/api/usuarios/actualizar/${this.dni}/`, datosActualizados, { headers }).subscribe(
      (response) => {
